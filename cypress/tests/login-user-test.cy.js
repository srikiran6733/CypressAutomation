...
describe('Login Functionality', () => {
 ...
 cy.visit(constants.baseUrl)
        ...
        cy.get(HomePage.automationExerciseLogoElement).should('be.visible');
        cy.xpath(HomePage.signupLoginLink).should('be.visible').click();
        cy.get(SignupLoginPage.loginToUserAccHeaderTextElement).should('be.visible')
        DataLoader.fillForm(SignupLoginPage, SignUpData.loginUser);
        cy.xpath(HomePage.loggedInAsUsernameElement).should('be.visible').and('contain.text', SignUpData.prePopulatedData.signupName);
        ...
        cy.xpath(HomePage.signupLoginLink).should('be.visible').click();
        cy.get(SignupLoginPage.loginToUserAccHeaderTextElement).should('be.visible')
        DataLoader.fillForm(SignupLoginPage, SignUpData.invalidLoginUser);
        cy.xpath(SignupLoginPage.loginToYourAccErrorMessageElement).should('be.visible')
        cy.xpath(SignupLoginPage.loginToYourAccErrorMessageElement).should('contain.text', 'Your email or password is incorrect!');
    });
